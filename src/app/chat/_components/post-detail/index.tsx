...
import PostContent from '@/app/post/_components/post-content';
import RecruitInfo from '@/app/post/_components/recruit-info';
import RecruitStatus from '@/app/post/_components/recruit-status';
