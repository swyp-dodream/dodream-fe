...
import PostDeleteButton from '@/app/(default-layout)/post/_components/post-delete-button';
import PostEditButton from '@/app/(default-layout)/post/_components/post-edit-button';
