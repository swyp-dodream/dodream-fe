    ...
    <>
      <div className="relative">
        ...
        {isOverflow && !isExpanded && (
          <div
            aria-hidden={true}
            className="absolute bottom-0 left-0 right-0 w-full h-[80px] bg-linear-to-b from-bg-dropdown-white-10 to-bg-surface pointer-events-none"
          />
        )}
      </div>
